var $intern_2414 = ') nije podr\u017Ean.', $intern_2412 = '<\/strong> je ve\u0107a od dozvoljene (', $intern_2416 = '<\/strong> nije dozvoljen za otpremanje.', $intern_2409 = '<\/strong> nije ispravan.', $intern_2433 = 'AsyncLoader2', $intern_2402 = 'CMS je nai\u0161ao na problem!', $intern_2405 = 'Do\u0161lo je do gre\u0161ke prilikom objavljivanja.', $intern_2418 = 'Email veza', $intern_2420 = 'Kliknite da bi ste izmenili', $intern_2422 = 'Kliknite za dodavanje Flash-a', $intern_2424 = 'Kliknite za dodavanje Google mape', $intern_2423 = 'Kliknite za dodavanje HTML koda', $intern_2425 = 'Kliknite za dodavanje video zapisa', $intern_2408 = 'Konfiguracioni parametar <strong>', $intern_2434 = 'MessagesSr_', $intern_2430 = 'Nepoznata gre\u0161ka', $intern_2407 = 'Ni jedan poku\u0161aj snimanja poslednjih izmena nije uspeo.', $intern_2410 = 'Nije mogu\u0107e kreirati mapu na osnovu unetog koda.', $intern_2417 = 'Nije mogu\u0107e kreirati video na osnovu unetog koda.', $intern_2432 = 'Nova verzija CMS-a je <a href=http://sitecake.com/download.html target=_blank>dostupna<\/a> (', $intern_2426 = 'Odaberite audio zapise za prenos', $intern_2427 = 'Odaberite datoteke za prenos', $intern_2428 = 'Odaberite slike za prenos', $intern_2429 = 'Odaberite video zapise za prenos', $intern_2413 = 'Odabran tip datoteke (', $intern_2415 = 'Odabrani tip datoteke <strong>', $intern_2401 = 'Podrazumevani stil', $intern_2404 = 'Poku\u0161aj da se snime poslednje izmene nije uspeo. Poku\u0161avam ponovo...', $intern_2403 = 'Pomozite nam da otklonimo problem, recite nam <a target="_blank" href="http://support.sitecake.com/anonymous_requests/new">\u0161ta se dogodilo<\/a>. Molimo Vas da prilo\u017Eite i donji izvi\u0161taj. Za nastavak rada dovoljno je da <a href="javascript:location.reload()">osve\u017Eite<\/a> stranicu.', $intern_2400 = 'Poslednje izmene nisu jo\u0161 sa\u010Duvane. Da li ste sigurni da \u017Eelite da nastavite?', $intern_2431 = 'Prenos:', $intern_2406 = 'Prilikom otpremanja se dogodila gre\u0161ka.', $intern_2411 = 'Veli\u010Dina odabrane datoteke <strong>', $intern_2421 = 'Vi\u0161e', $intern_2419 = 'Web veza', $intern_2399 = 'runCallbacks2';
...
function com_google_gwt_lang_asyncloaders_AsyncLoader2_onLoad__V(){
  ...
  !!$stats && $stats(com_google_gwt_core_client_impl_AsyncFragmentLoader$StandardLogger_$createStatsEvent__Lcom_google_gwt_core_client_impl_AsyncFragmentLoader$StandardLogger_2Ljava_lang_String_2Ljava_lang_String_2IILcom_google_gwt_core_client_JavaScriptObject_2($intern_2399, $intern_144, -1, -1));
  com_google_gwt_lang_asyncloaders_AsyncLoader2_instance.runCallbacks__V();
  !!$stats && $stats(com_google_gwt_core_client_impl_AsyncFragmentLoader$StandardLogger_$createStatsEvent__Lcom_google_gwt_core_client_impl_AsyncFragmentLoader$StandardLogger_2Ljava_lang_String_2Ljava_lang_String_2IILcom_google_gwt_core_client_JavaScriptObject_2($intern_2399, $intern_2360, -1, -1));
}
...
_.errorMessage2__Ljava_lang_String_2 = function com_sitecake_contentmanager_client_resources_MessagesSr_1_errorMessage2__Ljava_lang_String_2(){
  return java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(new java_lang_StringBuffer_StringBuffer__V, $intern_2403).java_lang_StringBuffer_impl.com_google_gwt_core_client_impl_StringBufferImplAppend_string;
}
;
...
_.failedToUploadFiles__Ljava_lang_String_2 = function com_sitecake_contentmanager_client_resources_MessagesSr_1_failedToUploadFiles__Ljava_lang_String_2(){
  return java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(new java_lang_StringBuffer_StringBuffer__V, $intern_2406).java_lang_StringBuffer_impl.com_google_gwt_core_client_impl_StringBufferImplAppend_string;
}
;
...
_.giveUpContentSaving__Ljava_lang_String_2 = function com_sitecake_contentmanager_client_resources_MessagesSr_1_giveUpContentSaving__Ljava_lang_String_2(){
  return java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(new java_lang_StringBuffer_StringBuffer__V, $intern_2407).java_lang_StringBuffer_impl.com_google_gwt_core_client_impl_StringBufferImplAppend_string;
}
;
...
_.invalidMapInputCode__Ljava_lang_String_2 = function com_sitecake_contentmanager_client_resources_MessagesSr_1_invalidMapInputCode__Ljava_lang_String_2(){
  return java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(new java_lang_StringBuffer_StringBuffer__V, $intern_2410).java_lang_StringBuffer_impl.com_google_gwt_core_client_impl_StringBufferImplAppend_string;
}
;
...
_.invalidUploadFileMaxSize__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2 = function com_sitecake_contentmanager_client_resources_MessagesSr_1_invalidUploadFileMaxSize__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2(arg0, arg1){
  return java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(new java_lang_StringBuffer_StringBuffer__V, $intern_2411), arg0), $intern_2412), arg1), $intern_2375).java_lang_StringBuffer_impl.com_google_gwt_core_client_impl_StringBufferImplAppend_string;
}
;
_.invalidUploadFileSelection__Ljava_lang_String_2Ljava_lang_String_2 = function com_sitecake_contentmanager_client_resources_MessagesSr_1_invalidUploadFileSelection__Ljava_lang_String_2Ljava_lang_String_2(arg0){
  return java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(new java_lang_StringBuffer_StringBuffer__V, $intern_2413), arg0), $intern_2414).java_lang_StringBuffer_impl.com_google_gwt_core_client_impl_StringBufferImplAppend_string;
}
;
...
_.selectFilesToUploadGeneric__Ljava_lang_String_2 = function com_sitecake_contentmanager_client_resources_MessagesSr_1_selectFilesToUploadGeneric__Ljava_lang_String_2(){
  return java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(new java_lang_StringBuffer_StringBuffer__V, $intern_2427).java_lang_StringBuffer_impl.com_google_gwt_core_client_impl_StringBufferImplAppend_string;
}
;
_.selectFilesToUploadImage__Ljava_lang_String_2 = function com_sitecake_contentmanager_client_resources_MessagesSr_1_selectFilesToUploadImage__Ljava_lang_String_2(){
  return java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(new java_lang_StringBuffer_StringBuffer__V, $intern_2428).java_lang_StringBuffer_impl.com_google_gwt_core_client_impl_StringBufferImplAppend_string;
}
;
_.selectFilesToUploadVideo__Ljava_lang_String_2 = function com_sitecake_contentmanager_client_resources_MessagesSr_1_selectFilesToUploadVideo__Ljava_lang_String_2(){
  return java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(new java_lang_StringBuffer_StringBuffer__V, $intern_2429).java_lang_StringBuffer_impl.com_google_gwt_core_client_impl_StringBufferImplAppend_string;
}
;
_.uncaughtException__Ljava_lang_String_2 = function com_sitecake_contentmanager_client_resources_MessagesSr_1_uncaughtException__Ljava_lang_String_2(){
  return java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2Ljava_lang_StringBuffer_2(new java_lang_StringBuffer_StringBuffer__V, $intern_2430).java_lang_StringBuffer_impl.com_google_gwt_core_client_impl_StringBufferImplAppend_string;
}
;
